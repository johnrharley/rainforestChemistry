...
dem <- raster("~/Data Blog/DEM/shapefiles/shapefiles/dem_GOA.tif")
...
ggsave("karst.png",karst_fig, height=4, width=4, dpi=300)
...
stamen <- paste0('http://a.tile.stamen.com/terrain-background/${z}/${x}/${y}.png')

wsmap <- SEAKDB %>%
  left_join(lowsPtsMatch, by="WS_ID") %>%
  ggplot() +
    annotation_map_tile(type = stamen,
...
ggsave(wsmap, "WSmapAdjusted.png", height=12, width=14, dpi=300)
